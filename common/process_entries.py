...
def create_prescriptions():
    ...
    prescriptions.to_hdf('data/processed_data/hdf/prescriptions.hdf','prescriptions',mode='w')
...
def create_clinicals():
    ...
    clinicals.to_hdf('data/processed_data/hdf/clinicals.hdf','clinicals',mode='w')
...
def create_tests():
    ...
    tests.to_hdf('data/processed_data/hdf/tests.hdf','tests',mode='w')
...
def create_referrals():
    ...
    referrals.to_hdf('data/processed_data/hdf/referrals.hdf','referrals',mode='w')
...
def create_consultations():
    ...
    #logging.debug('writing to csv')
    consultations.to_hdf('data/processed_data/hdf/consultations.hdf','consultations',mode ='w')
...
def create_immunisations():
    ...
    immunisations.to_hdf('data/processed_data/hdf/immunisations.hdf','immunisations',mode='w')
...
def create_medcoded_entries():
    ...
    """
    clinicals = pd.read_hdf('data/processed_data/hdf/clinicals.hdf')[['patid','sysdate','eventdate','medcode']]
    clinicals['type']=entry_type['clinical']

    tests = pd.read_hdf('data/processed_data/hdf/tests.hdf')[['patid','sysdate','eventdate','medcode']]
    tests['type']=entry_type['test']

    referrals = pd.read_hdf('data/processed_data/hdf/referrals.hdf')[['patid','sysdate','eventdate','medcode']]
    referrals['type']=entry_type['referral']

    immunisations = pd.read_hdf('data/processed_data/hdf/immunisations.hdf')[['patid','sysdate','eventdate','medcode']]
    ...
    medcoded_entries.to_hdf('data/processed_data/hdf/medcoded_entries.hdf','medcoded_entries',mode='w')
...
def get_all_encounters():
    ...
    consultations = pd.read_hdf('data/processed_data/hdf/consultations.hdf')[['patid','sysdate','eventdate']]
